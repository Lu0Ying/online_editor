import { $ as createRelativePositionFromTypeIndex, Ot as isParentOf, Q as createRelativePositionFromJSON, W as compareRelativePositions, Xt as timeout, Z as createID, an as unexpectedCase, cn as min, dn as setIfUndefined, q as createAbsolutePositionFromRelativePosition, sn as max, un as create, xt as findRootTypeKey, y as RelativePosition, z as YXmlText } from "./yjs-HykgBO2t.js";
import { _n as DecorationSet, bn as Plugin, gn as Decoration, i as Extension, xn as PluginKey } from "./dist-BlMRfnZb.js";
import "./awareness-D-qb1PyI.js";
...
//#endregion
//#region node_modules/@tiptap/extension-collaboration-cursor/dist/index.js
...
var CollaborationCursor = Extension.create({
	...
	onCreate() {
		if (this.options.onUpdate !== defaultOnUpdate) console.warn("[tiptap warn]: DEPRECATED: The \"onUpdate\" option is deprecated. Please use `editor.storage.collaborationCursor.users` instead. Read more: https://tiptap.dev/api/extensions/collaboration-cursor");
	},
	addStorage() {
		return { users: [] };
	},
